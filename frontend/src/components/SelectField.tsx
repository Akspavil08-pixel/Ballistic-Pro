  ...
  return (
    <div className="field-row flex flex-col gap-2">
      ...
      <div className="field-input">
        <select
          id={id}
          className="field-control w-full rounded-lg border border-slate-700/70 bg-slate-900/70 px-3 py-2 text-sm text-slate-100 focus:outline-none focus:ring-2 focus:ring-emerald-400/60"
          value={value}
